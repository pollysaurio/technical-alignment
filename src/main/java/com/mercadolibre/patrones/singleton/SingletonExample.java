...
public class SingletonExample {
    ...
    /* Al declarar un objeto de esa manera le damos un estado al objeto, la variable valores puede cambiar su valor y modificar el estado del objeto */
    ...
    private SingletonExample() {
        System.out.println("I'm a Singleton :D ");
    }
